<div id="header">
					...
					<ul class="top-details menu-beta l-inline">
						@if(Auth::check())
							...
							<li><form action="{{ route('logout') }}" method="post">
								@method('post')
								@csrf
								<button class="btn btn-light btn-block" type="submit"></i>dang xuat</button>
							</form></li>
						@else
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.html" id="logo"><img src="btr/assets/dest/images/logo-cake.png" width="200px" alt=""></a>
				</div>
				<div class="pull-right beta-components space-left ov">
					<div class="space10">&nbsp;</div>
					<div class="beta-comp">
						<form action="{{ route('search') }}" role="search" for="search" method="get" id="searchform">
								...
								<div class="beta-dropdown cart-body">
									@if(Session::has('cart'))
										...
										<div class="cart-item">
											...
											<div class="media">
												<a class="pull-left" href="#"><img src="btr/image/product/{{ $product['item']['image'] }}" alt=""></a>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						<li><a href="{{ asset('') }}index">Trang chủ</a></li>
